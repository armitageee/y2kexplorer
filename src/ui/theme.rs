...
// Основной контент
pub const TITLE: Style = Style::new().fg(Color::LightCyan).add_modifier(Modifier::BOLD);
pub const HEADER: Style = Style::new().fg(Color::LightBlue).add_modifier(Modifier::BOLD);
pub const SELECTED: Style = Style::new().fg(Color::Black).bg(Color::Yellow).add_modifier(Modifier::BOLD);
pub const ROW: Style = Style::new().fg(Color::White);
pub const KEY: Style = Style::new().fg(Color::LightMagenta).add_modifier(Modifier::BOLD);
pub const VALUE: Style = Style::new().fg(Color::White);
pub const ERROR: Style = Style::new().fg(Color::Red).bg(Color::Black).add_modifier(Modifier::BOLD);
pub const SUCCESS: Style = Style::new().fg(Color::LightGreen).add_modifier(Modifier::BOLD);
...
pub const MODAL_BORDER: Style = Style::new().fg(Color::Yellow).bg(Color::Black).add_modifier(Modifier::BOLD);
...
pub const MODAL_CURSOR: Style = Style::new().fg(Color::Black).bg(Color::White).add_modifier(Modifier::BOLD);
